 ...
 */
function createSaddlePointFinder(valueCalculator) {
  // Module-scoped variables
  let ante, bet, cardRange, vMatrix;

  function findSaddlePoints(var_ante, var_bet, var_cardRange, logPrefix = "") {
  ...
  function value(strat1, strat2) {
    return valueCalculator(strat1, strat2, ante, bet, cardRange);
  }
  ...
  return { findSaddlePoints };
}

export { createSaddlePointFinder };
